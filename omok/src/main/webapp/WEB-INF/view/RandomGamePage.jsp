...
<script>
    ...
    webSocket.onmessage = function (event) {
        ...
        console.log("상대편이 놓은 X 좌표 : " + x + ", Y 좌표 : " + y);

        // 상대편이 놓은 돌을 화면에 표시하는 코드 추가
        var blackStone = document.createElement('div');
        blackStone.className = 'stone black';
        blackStone.style.left = x + 'px';
        blackStone.style.top = y + 'px';
        document.getElementById('go').appendChild(blackStone);
    };
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        board.addEventListener('click', function (event) {
            ...
            webSocket.onmessage = function(event){
                ...
                // 상대편이 놓은 돌을 화면에 표시하는 코드
                var whiteStone = document.createElement('img');
                whiteStone.src = '/img/whitedot.png';
                whiteStone.className = 'stone';
                whiteStone.style.left = (x * 53 + 34) + 'px';
                whiteStone.style.top = (y * 53 + 34) + 'px';
                whiteStone.style.width = '53px';
                whiteStone.style.height = '53px';
                whiteStone.style.position = 'absolute';
                whiteStone.style.zIndex = '6';
                document.getElementById('go').appendChild(whiteStone);
            };
